...
function BannerSection({ image, title, subtitle, moTitle, MoSubtitle, buttonText }) {
  return (
    <div className="relative font-poppins z-0">
      ...
      <div className="absolute top-1/3 text-center text-white px-4 flex flex-col items-center w-full justify-center md:px-20 lg:px-40">
        ...
        {buttonText && <button className="mt-6 p-2 rounded-lg bg-[#9a2002] font-medium md:w-32 xl:w-44 xl:text-[24px]">{buttonText}</button>}
      </div>
    </div>
  );
}
