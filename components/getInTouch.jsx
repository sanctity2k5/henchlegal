    ...
    <div>
      ...
      <form className="flex flex-col px-4 md:px-20 lg:px-40">
        <span className="flex flex-col mt-6">
          <label htmlFor="name" className="xl:text-[24px]">
        ...
        <span className="flex flex-col">
          <label htmlFor="email" className="xl:text-[24px]">
        ...
        <span className="flex flex-col">
          <label htmlFor="message" className="xl:text-[24px]">
      ...
      <section className="px-4 mt-10 md:px-20 lg:px-40">
        <h1 className="text-[18px] font-semibold mb-4">SUITE F1 ROYAL PLAZA AJIRAN LEKKI</h1>
        <iframe
